        ...
        <Card key={review.id} className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-0 overflow-hidden">
          <CardContent className="p-6">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="text-xs px-2 py-1 rounded-full uppercase tracking-wide bg-gray-100 text-gray-600">
                {review.channel}
              </div>
            </div>
            ...
            {/* Review text */}
            <blockquote className="text-sm leading-relaxed mb-4 italic text-gray-600">
              "{review.comment}"
            </blockquote>
            ...
            <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => onReviewApprove(review.id, !review.isApproved)}
                className="flex-1"
              >
